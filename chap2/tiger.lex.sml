...
fun yyAction46 (strm, lastMatch : yymatch) = (yystrm := strm;
      (if !commentCounter < 2 then (YYBEGIN (INITIAL)) else (); commentCounter:= !commentCounter-1; continue()))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ83(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ87(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ45(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ92(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #" "
                  ...
                  else yyQ94(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp = #"]"
              then yyQ94(strm', yyMATCH(strm, yyAction44, yyNO_MATCH))
            else if inp < #"]"
              then if inp = #"\\"
        ...
        | SOME(inp, strm') =>
            if inp = #"#"
              ...
              then if inp = #" "
                  ...
                  else yyQ94(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"]"
              then yyQ94(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp < #"]"
              then if inp = #"\\"
